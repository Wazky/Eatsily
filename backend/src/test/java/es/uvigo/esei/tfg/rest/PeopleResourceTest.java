...
import static es.uvigo.esei.tfg.dataset.PeopleDataset.existentId;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.existentPerson;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.newName;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.newPerson;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.newSurname;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.nonExistentId;
import static es.uvigo.esei.tfg.dataset.PeopleDataset.people;
import static es.uvigo.esei.tfg.dataset.UsersDataset.adminLogin;
import static es.uvigo.esei.tfg.dataset.UsersDataset.normalLogin;
import static es.uvigo.esei.tfg.dataset.UsersDataset.userToken;
import static es.uvigo.esei.tfg.matchers.HasHttpStatus.hasBadRequestStatus;
import static es.uvigo.esei.tfg.matchers.HasHttpStatus.hasOkStatus;
import static es.uvigo.esei.tfg.matchers.HasHttpStatus.hasUnauthorized;
import static es.uvigo.esei.tfg.matchers.IsEqualToPerson.containsPeopleInAnyOrder;
import static es.uvigo.esei.tfg.matchers.IsEqualToPerson.equalsToPerson;
...
import es.uvigo.esei.tfg.DAAExampleTestApplication;
import es.uvigo.esei.tfg.entities.Person;
import es.uvigo.esei.tfg.listeners.ApplicationContextBinding;
import es.uvigo.esei.tfg.listeners.ApplicationContextJndiBindingTestExecutionListener;
import es.uvigo.esei.tfg.listeners.DbManagement;
import es.uvigo.esei.tfg.listeners.DbManagementTestExecutionListener;
